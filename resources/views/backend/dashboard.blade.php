...
<main class="w-full h-full overflow-y-auto">
    <div class="container px-6 mx-auto">
        ...
        <div class="flex justify-end mb-2">
            <a href="{{ url('task/add') }}" class="px-4 py-2 font-medium leading-5 text-white transition-colors bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
            ...
            <table id="tasktable" class="w-full whitespace-no-wrap task-table">
                <thead>
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    @foreach ($tasks as $task)
                        <tr id="task-item-{{ $task->id }}" class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-center"><a href="javascript:;" onclick="window.location.replace('{{ url('task/edit/'.$task->id) }}')" class="text-green-500"><fa class="fa fa-pen"></fa></a></td>
                            <td class="px-4 py-3 text-center text-red-500"><a href="javascript:;"  onclick="delete_task({{ $task->id }})" class="text-red-500"><fa class="fa fa-trash"></fa></a></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
